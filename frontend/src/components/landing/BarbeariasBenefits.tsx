  ...
  const benefits = [
    {
      ...
      metric: '+45%',
      description: 'Crescimento médio na base de clientes com melhor gestão'
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      metric: '-30%',
      description: 'Redução nos custos operacionais da barbearia'
    },
    {
      icon: Users,
      title: 'Equipe Produtiva',
      metric: '+75%',
      description: 'Aumento na produtividade dos barbeiros'
    },
    {
      icon: Shield,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Mais de 2.100 barbearias já transformaram sua gestão e viram resultados extraordinários
          </p>
        </div>
