  ...
  const benefits = [
    {
      ...
      metric: 'em até 45%',
      description: 'Aumente o número de clientes e agendamentos com sistema inteligente e fidelização.',
    ...
    },
    {
      ...
      title: 'Reduza Tempo',
      metric: 'de 70%',
      description: 'Automatize agendamentos e processos para focar no que faz melhor: cortar cabelo.',
    ...
    },
    {
      ...
      metric: 'até 30%',
      description: 'Controle inteligente de estoque e otimização de recursos para sua barbearia crescer.',
    ...
    },
    {
      ...
      metric: '100%',
      description: 'Funcionários mais produtivos com ferramentas intuitivas e controle de comissões.',
    ...
    },
    {
      ...
      metric: '24/7',
      description: 'Configuração completa com segurança de nível militar para proteger dados dos clientes.',
    ...
    },
    {
      ...
      metric: '24h',
      description: 'Configuração completa em até 24 horas com suporte especializado e treinamento completo.',
      features: ['100% Suporte', '99% Rapidez', '24/7 Assistência']
    }
  ]

  const stats = [
    { number: '2.1K+', label: 'Barbearias Ativas' },
    { number: '450K+', label: 'Agendamentos/Mês' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Veja os resultados reais que nossos clientes alcançaram com o Vynlo Barber
          </p>
        </div>
