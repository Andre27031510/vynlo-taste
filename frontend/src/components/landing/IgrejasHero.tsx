...
import { ChevronLeft, ChevronRight, Users, Heart, Calendar, BarChart3, DollarSign, MessageSquare } from 'lucide-react'
  ...
  const slides = [
    {
      ...
      subtitle: 'Organize sua congregação',
      description: 'Sistema completo para cadastro, acompanhamento e crescimento espiritual dos membros',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Controle financeiro completo com relatórios transparentes e prestação de contas',
      icon: Heart,
    ...
    },
    {
      ...
      description: 'Agendamento de cultos, eventos especiais e comunicação eficaz com os fiéis',
      icon: Calendar,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-6 py-3">
              ...
              <span className="text-blue-300 font-manrope font-semibold text-sm">Gestão para Igrejas</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Igrejas Ativas</div>
              </div>
              <div className="text-center">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-purple-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-purple-300 text-sm">Dízimos</span>
                    </div>
