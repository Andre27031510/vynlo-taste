...
export default function PetshopsHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-6 py-3">
              ...
              <span className="text-blue-300 font-manrope font-semibold text-sm">Sistema para Petshops</span>
            </div>
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Sistema profissional para cadastro de pets, controle de vacinas, agendamento de serviços e gestão completa do seu petshop.
            </p>

            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">1.8K+</div>
                <div className="text-gray-400 text-sm">Petshops</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">280K+</div>
                <div className="text-gray-400 text-sm">Pets Cadastrados</div>
              </div>
              <div className="text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="bg-gray-900 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-white text-sm font-medium">Painel Petshop</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-blue-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-blue-300 text-sm">Pets</span>
                    </div>
                  ...
                  <div className="bg-green-500/20 rounded-xl p-4">
                    ...
                    <div className="text-2xl font-bold text-white">R$ 28K</div>
                  </div>
                </div>
                ...
                <div className="bg-gray-800 rounded-xl p-4">
                  ...
                  <div className="h-20 flex items-end space-x-1">
                    {[55, 72, 68, 81, 75, 87, 79, 92, 84, 98, 89, 95].map((height, i) => (
                      <div
                        key={i}
