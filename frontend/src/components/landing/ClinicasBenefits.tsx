...
export default function ClinicasBenefits() {
  const benefits = [
    {
      icon: TrendingUp,
      metric: '+50%',
        ...
        <div className="mt-20 bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
          <div className="text-center">
            ...
            <blockquote className="text-2xl font-manrope font-medium text-white mb-6 leading-relaxed">
              "O sistema revolucionou nossa clínica. Conseguimos atender mais pacientes com maior qualidade e nosso faturamento aumentou significativamente."
            </blockquote>
            <div className="text-blue-300 font-semibold">Dr. Carlos Mendes</div>
            <div className="text-gray-400">Clínica São Lucas - São Paulo</div>
          </div>
        </div>
      </div>
    </section>
