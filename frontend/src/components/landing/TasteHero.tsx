...
import { Star, Users, TrendingUp, Utensils } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-6 py-3">
              ...
              <span className="text-blue-300 font-manrope font-semibold text-sm">Sistema para Restaurantes</span>
            </div>
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Sistema profissional para gestão de pedidos, controle de estoque, delivery e análises completas. Transforme seu restaurante com tecnologia de ponta.
            </p>

            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">500+</div>
                <div className="text-gray-400 text-sm">Restaurantes</div>
              </div>
              <div className="text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="bg-gray-900 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-white text-sm font-medium">Painel Restaurante</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-blue-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-blue-300 text-sm">Pedidos</span>
                    </div>
                ...
                <div className="bg-gray-800 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-green-400 text-xs">+22% hoje</span>
                    </div>
                  </div>
