...
export default function EducacaoBenefits() {
  const benefits = [
    {
      ...
      metric: 'em até 40%',
      description: 'Aumente o número de alunos e reduza inadimplência com gestão inteligente e transparente.',
    ...
    },
    {
      ...
      title: 'Reduza Tempo',
      metric: 'de 70%',
      description: 'Automatize processos burocráticos e foque no que realmente importa: a educação.',
    ...
    },
    {
      ...
      metric: 'até 30%',
      description: 'Controle inteligente de gastos e otimização de recursos para sua escola crescer.',
    ...
    },
    {
      ...
      metric: '100%',
      description: 'Funcionários e professores mais produtivos com ferramentas pedagógicas avançadas.',
    ...
    },
    {
      ...
      metric: '24/7',
      description: 'Configuração completa com segurança de nível militar para proteger dados dos alunos.',
  ...
  const stats = [
    { number: '800+', label: 'Escolas Ativas' },
    { number: '120K+', label: 'Alunos Cadastrados' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Veja os resultados reais que nossos clientes alcançaram com o Vynlo Edu
          </p>
        </div>
