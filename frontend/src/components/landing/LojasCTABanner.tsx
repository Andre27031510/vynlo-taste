...
export default function LojasCTABanner() {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="text-center lg:text-left">
            <h3 className="text-2xl lg:text-3xl font-manrope font-black text-white mb-4">
              Transforme sua Loja hoje mesmo
            </h3>
            <p className="text-blue-100 text-lg mb-6 lg:mb-0">
              Junte-se a mais de 2.500 lojas que já revolucionaram sua gestão
            </p>
          </div>
