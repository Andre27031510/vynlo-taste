...
import { ChevronLeft, ChevronRight, ShoppingBag, Package, BarChart3, DollarSign, Users } from 'lucide-react'

export default function LojasHero() {
  const [currentSlide, setCurrentSlide] = useState(0)

  const slides = [
    {
      title: 'Gestão de Vendas',
      subtitle: 'PDV completo',
      description: 'Sistema de vendas integrado com controle de estoque e relatórios em tempo real',
      icon: ShoppingBag,
      color: 'from-blue-500 to-cyan-500'
    },
    {
      title: 'Controle de Estoque',
      subtitle: 'Nunca fique sem produtos',
      description: 'Gestão inteligente de estoque com alertas automáticos e controle de fornecedores',
      icon: Package,
    ...
    },
    {
      ...
      description: 'Dashboards completos com análise de vendas, produtos mais vendidos e performance',
      icon: BarChart3,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-6 py-3">
              ...
              <span className="text-blue-300 font-manrope font-semibold text-sm">Gestão para Lojas</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Lojas Ativas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">1M+</div>
                <div className="text-gray-400 text-sm">Vendas/Mês</div>
              </div>
              <div className="text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="bg-gray-900 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-white text-sm font-medium">Painel Loja</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-blue-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-blue-300 text-sm">Vendas Hoje</span>
                    </div>
                    <div className="text-2xl font-bold text-white">R$ 8.5K</div>
                  </div>
                  <div className="bg-green-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      <Package className="w-4 h-4 text-green-400" />
                      <span className="text-green-300 text-sm">Produtos</span>
                    </div>
                ...
                <div className="bg-gray-800 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-green-400 text-xs">+22% mês</span>
                    </div>
                  </div>
