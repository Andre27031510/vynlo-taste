...
import { ChevronLeft, ChevronRight, Wrench, Car, Calendar, DollarSign, Users, BarChart3 } from 'lucide-react'
  ...
  const slides = [
    {
      ...
      description: 'Sistema completo para ordens de serviço, diagnósticos e acompanhamento de reparos',
      icon: Wrench,
    ...
    },
    {
      ...
      description: 'Cadastro de veículos, histórico de serviços e manutenções preventivas',
      icon: Car,
    ...
    },
    {
      ...
      description: 'Sistema de agendamento inteligente com lembretes e controle de agenda',
      icon: Calendar,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-6 py-3">
              ...
              <span className="text-blue-300 font-manrope font-semibold text-sm">Gestão para Oficinas</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Oficinas Ativas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">500K+</div>
                <div className="text-gray-400 text-sm">Serviços/Mês</div>
              </div>
              <div className="text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="bg-gray-900 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-white text-sm font-medium">Painel Oficina</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-blue-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-blue-300 text-sm">Serviços</span>
                    </div>
                  ...
                  <div className="bg-green-500/20 rounded-xl p-4">
                    ...
                    <div className="text-2xl font-bold text-white">R$ 85K</div>
                  </div>
                </div>

                <div className="bg-gray-800 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-white text-sm font-medium">Serviços</span>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                      <span className="text-green-400 text-xs">+18% mês</span>
                    </div>
                  </div>
