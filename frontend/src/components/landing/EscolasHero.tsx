...
import { ChevronLeft, ChevronRight, GraduationCap, Users, Calendar, BookOpen, DollarSign, BarChart3 } from 'lucide-react'

export default function EscolasHero() {
  ...
  const slides = [
    {
      ...
      description: 'Sistema completo para matrículas, notas, frequência e acompanhamento pedagógico',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Controle de mensalidades, boletos automáticos e relatórios financeiros completos',
      icon: DollarSign,
    ...
    },
    {
      ...
      description: 'Portal completo para alunos e pais acompanharem notas, frequência e comunicados',
      icon: GraduationCap,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-6 py-3">
              ...
              <span className="text-blue-300 font-manrope font-semibold text-sm">Gestão Escolar</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Escolas Ativas</div>
              </div>
              <div className="text-center">
