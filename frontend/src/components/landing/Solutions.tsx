...
export default function Solutions() {
  ...
  return (
    <section id="solutions" className="py-24 bg-gradient-to-br from-blue-900 via-slate-900 to-black relative overflow-hidden">
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Header */}
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-2 bg-blue-500/20 text-blue-300 px-4 py-2 rounded-full font-manrope font-medium text-sm mb-6">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-manrope font-bold text-gray-900 transition-colors duration-300">
                        {solution.stats.restaurants}
                      </div>
                      <div className="text-sm text-gray-500 font-manrope transition-colors duration-300">clientes</div>
                  ...
                  {/* Title & Description */}
                  <h3 className="text-2xl font-manrope font-bold text-gray-900 mb-4 transition-all duration-300">
                    {solution.title}
                  </h3>
                  
                  <p className="text-gray-700 font-manrope leading-relaxed mb-6 transition-all duration-300">
                  ...
                  <div className="space-y-3 mb-6">
                    {solution.features.map((feature, featureIndex) => (
                      ...
                      >
                        ...
                        <span className="text-gray-700 font-manrope transition-colors duration-300">{feature}</span>
                      </div>
                    ))}
                  </div>
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <div className="text-3xl font-manrope font-bold text-white mb-2">
                  {stat.value}
                </div>
