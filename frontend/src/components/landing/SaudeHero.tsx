        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-400/30 rounded-full px-6 py-3">
              ...
              <span className="text-blue-300 font-manrope font-semibold text-sm">Sistema para Saúde</span>
            </div>
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Sistema profissional para prontuários eletrônicos, agendamento de consultas, controle de medicamentos e gestão completa da área da saúde.
            </p>

            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">1.2K+</div>
                <div className="text-gray-400 text-sm">Clínicas</div>
              </div>
              <div className="text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="bg-gray-900 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-white text-sm font-medium">Painel Saúde</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-green-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-green-300 text-sm">Consultas</span>
                    </div>
                ...
                <div className="bg-gray-800 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-white text-sm font-medium">Atendimentos</span>
