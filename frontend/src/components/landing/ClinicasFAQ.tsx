...
export default function ClinicasFAQ() {
  ...
  const faqs = [
    ...
    {
      question: 'Funciona para clínicas de qualquer tamanho?',
      answer: 'Perfeitamente escalável desde consultórios individuais até grandes clínicas com múltiplas especialidades e unidades.'
    },
    {
      question: 'Qual o investimento mensal?',
      answer: 'Planos flexíveis a partir de R$ 197/mês com todas as funcionalidades. Oferecemos proposta personalizada para cada clínica.'
    }
  ]
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Esclarecemos as principais dúvidas sobre nosso sistema para clínicas
          </p>
        </div>
