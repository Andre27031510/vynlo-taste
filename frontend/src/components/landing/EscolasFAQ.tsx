...
export default function EscolasFAQ() {
  ...
  const faqs = [
    ...
    {
      question: 'Funciona para escolas de qualquer tamanho?',
      answer: 'Perfeitamente escalável desde pequenas escolas até grandes redes de ensino com milhares de alunos e múltiplas unidades.'
    },
    {
      question: 'Qual o investimento mensal?',
      answer: 'Planos flexíveis a partir de R$ 147/mês com todas as funcionalidades. Oferecemos proposta personalizada para cada escola.'
    }
  ]
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Esclarecemos as principais dúvidas sobre nosso sistema para escolas
          </p>
        </div>
