...
export default function IgrejasBenefits() {
  const benefits = [
    {
      ...
      metric: 'em até 40%',
      description: 'Aumente o engajamento e contribuições dos membros com gestão transparente e eficiente.',
    ...
    },
    {
      ...
      title: 'Reduza Tempo',
      metric: 'de 70%',
      description: 'Automatize processos administrativos e foque no que realmente importa: o ministério.',
    ...
    },
    {
      ...
      metric: 'até 30%',
      description: 'Controle inteligente de gastos e otimização de recursos para sua igreja crescer.',
    ...
    },
    {
      ...
      metric: '100%',
      description: 'Funcionários e voluntários mais produtivos com ferramentas intuitivas e completas.',
    ...
    },
    {
      ...
      metric: '24/7',
      description: 'Configuração completa com segurança de nível militar para proteger dados dos membros.',
  ...
  const stats = [
    { number: '500+', label: 'Igrejas Ativas' },
    { number: '50K+', label: 'Membros Cadastrados' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Veja os resultados reais que nossos clientes alcançaram com o Vynlo Ekklesia
          </p>
        </div>
