        ...
        <div className="mt-20 bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
          <div className="text-center">
            ...
            <blockquote className="text-2xl font-manrope font-medium text-white mb-6 leading-relaxed">
              "O sistema revolucionou nossa igreja. Conseguimos acompanhar melhor nossos membros e nossa transparência financeira aumentou a confiança da congregação."
            </blockquote>
            <div className="text-blue-300 font-semibold">Pastor João Silva</div>
            <div className="text-gray-400">Igreja Batista Central - São Paulo</div>
          </div>
        </div>
      </div>
    </section>
