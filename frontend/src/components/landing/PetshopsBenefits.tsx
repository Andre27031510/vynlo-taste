  ...
  const benefits = [
    {
      ...
      metric: 'em até 50%',
      description: 'Aumente vendas de produtos e serviços com controle inteligente e fidelização de tutores.',
    ...
    },
    {
      ...
      title: 'Reduza Tempo',
      metric: 'de 70%',
      description: 'Automatize cadastros de pets e processos para focar no cuidado dos animais.',
    ...
    },
    {
      ...
      metric: 'até 35%',
      description: 'Controle inteligente de estoque e otimização de recursos para seu petshop crescer.',
    ...
    },
    {
      ...
      metric: '100%',
      description: 'Funcionários e veterinários mais produtivos com ferramentas especializadas.',
    ...
    },
    {
      ...
      metric: '24/7',
      description: 'Configuração completa com segurança de nível militar para proteger dados dos pets.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-manrope font-black text-white mb-6">
            Transforme seu Petshop
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400">
              em 30 dias
            </span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Veja os resultados reais que nossos clientes alcançaram com o Vynlo Pet
          </p>
        </div>
