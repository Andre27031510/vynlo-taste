...
import { Scissors, Calendar, Users, TrendingUp } from 'lucide-react'

export default function BarbeariasHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-blue-600/40 backdrop-blur-sm border border-blue-400/30 rounded-full px-6 py-3">
              <Scissors className="w-5 h-5 text-blue-200" />
              <span className="text-white font-manrope font-semibold text-sm">Sistema para Barbearias</span>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="bg-gray-900 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-white text-sm font-medium">Painel Barbearia</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-blue-500/20 rounded-xl p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-blue-300 text-sm">Hoje</span>
                    </div>
                  ...
                  <div className="bg-green-500/20 rounded-xl p-4">
                    ...
                    <div className="text-2xl font-bold text-white">R$ 1.8K</div>
                  </div>
                </div>
