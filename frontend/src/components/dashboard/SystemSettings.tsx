            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-2 py-4 px-2 border-b-2 font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    activeTab === tab.id
            ...
            <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center space-x-3">
                        <input
                          ...
                          className="w-4 h-4 text-blue-600 border-adaptive rounded focus:ring-blue-500 focus:ring-offset-2"
                          aria-describedby="shadows-help"
                        />
                        <span id="shadows-help" className="sr-only">Ativa ou desativa sombras nos elementos da interface</span>
              ...
              <div className="flex items-center justify-end space-x-4 pt-6 border-t border-adaptive">
                <button
                  ...
                  disabled={isProcessing}
                  className="btn-ghost px-6 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  aria-label="Resetar configurações de aparência para valores padrão"
                >
                  Resetar
                </button>
                <button
                  ...
                  disabled={isProcessing}
                  className="btn-primary px-6 py-3 rounded-xl font-bold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  aria-label={isProcessing ? 'Salvando configurações de aparência' : 'Salvar configurações de aparência'}
                >
