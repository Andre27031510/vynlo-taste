...
export default function Header({ sidebarCollapsed, setSidebarCollapsed }: HeaderProps) {
  ...
  // Navegação por teclado no menu do usuário
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <button
            ...
            className={`lg:hidden p-2 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
              currentTheme === 'dark'
          ...
          <div className="relative">
            ...
            <div id="search-help" className="sr-only">
              Digite para buscar pedidos, clientes ou produtos. Pressione Escape para limpar.
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className={`flex items-center space-x-1 rounded-lg p-1 ${
            ...
            <button
              ...
              className={`p-2 rounded-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                currentTheme === 'light'
          ...
          >
            ...
            <span 
              ...
              aria-hidden="true"
            ></span>
            <span id="notification-count" className="sr-only">3 notificações não lidas</span>
          </button>
          ...
          <div className="relative" ref={userMenuRef}>
            <button
              ...
              className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            ...
            {showUserMenu && (
              ...
              >
                ...
                <button
                  onClick={logout}
                  className="w-full px-4 py-2 text-left text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 flex items-center space-x-2 focus:outline-none focus:bg-red-50 dark:focus:bg-red-900/20"
                  role="menuitem"
                >
