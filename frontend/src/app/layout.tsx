...
export const metadata: Metadata = {
  title: 'Vynlo Taste - Sistema de Gestão',
  description: 'Plataforma completa para gestão de restaurantes com tecnologia avançada',
  ...
  metadataBase: new URL('https://vynlotech.com'),
  openGraph: {
    title: 'Vynlo Taste - Sistema de Gestão',
