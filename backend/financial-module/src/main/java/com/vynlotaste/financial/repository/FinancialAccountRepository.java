...
public interface FinancialAccountRepository extends JpaRepository<FinancialAccount, Long> {
    ...
    // Buscas por datas (dueDate e closingDate são Integer representando dia do mês)
    List<FinancialAccount> findByDueDateLessThan(Integer day);
    List<FinancialAccount> findByClosingDateLessThan(Integer day);
    ...
    @Query("SELECT a FROM FinancialAccount a WHERE a.restaurant.id = :restaurantId AND a.dueDate <= :day AND a.status = :status")
